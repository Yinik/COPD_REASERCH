...
| 成员 | 学号 | 主要负责内容 |
|------|------|-------------|
| 尹鑫 | 2024213808 | 项目整体架构设计、PDF清洗与文本预处理、关系抽取方案设计、知识图谱构建与可视化、评估报告撰写 |
| 苟玉莲 | 2024213774 | 医学文献收集与整理、种子词典构建与实体标注、人工审核与质量把控、GOLD指南覆盖率分析、中期汇报材料准备 |
...
├── 关系抽取结果/生成Neo4j导入.py       # 生成Neo4j导入文件
